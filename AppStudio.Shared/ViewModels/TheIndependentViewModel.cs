...
{
    public class TheIndependentViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "TheIndependentDataSource"; }
        }
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("TheIndependentDetail", item);
                        });
                }
        ...
        {
            return new TheIndependentDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TheIndependentList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TheIndependentDetail");
        }
    }
}
